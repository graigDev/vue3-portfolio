  ...
  <div class="w-full max-w-4xl mx-auto py-8 px-4">
    ...
    <div class="flex flex-col sm:flex-row md:items-center mb-20">
      <div class="md:w-3/5">
        ...
        <div class="text-sm leading-loose font-medium text-gray-700 pr-4">
      ...
      <div class="flex sm:justify-end w-full mt-6 sm:mt-0 md:w-2/5 relative">
        <div class="absolute w-full h-full sm:w-52 sm:h-56 -right-2 top-2 sm:-right-4 sm:top-4  border-2 border-teal-600 rounded"></div>
        <div class="w-full h-80 sm:w-52 sm:h-56 rounded overflow-hidden bg-teal-600 z-10 relative">
          <img src="@/assets/img/me.jpeg" class="w-full h-full object-cover" alt="">
          <span class="absolute inset-0 bg-teal-600 bg-opacity-30 hover:bg-opacity-0"></span>
        </div>
      </div>
    </div>
    ...
    <div class="flex flex-col space-y-10">
      ...
      <div>
        <BaseTitle number="04" title="Gestion de projets et collaboration"/>
